...
from EnsembleModel.Logger import Logger
from EnsembleModel.EnsembleStats import EnsembleStats
...
class EnsembleModel:
    ...
    def __init__(self,
        ...
        """
        self.__weight_sum_min = weight_sum_min
        self.__weight_sum_max = weight_sum_max
        self.__weight_max = weight_max
        self.__trials_max = trials_max
        self.__iteration_max = iteration_max
        self.__alpha_ensemble_min = alpha_ensemble_min
        self.__alpha_model_min = alpha_model_min
        ...
        self.__ensemble_type = ensemble_type

        self.__logger_main = Logger(app_name=output_name, path=output_path, ext="log")
        self.__logger = logging.getLogger(output_name)
        self.log_output_path_full = self.__logger_main.path_full
    ...
    @staticmethod
    def __ensemble_select_submodel_y_hat(y_hat_submodels: np.ndarray,
    ...
    @staticmethod
    def __ensemble_report(performance: Dict[str, float]
                          ) -> str:
